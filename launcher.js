const g_Version = "0.05";
var scr_parent = document.getElementById("guide_main");
if (scr_parent == null) {
  alert("[for管理者]\n設置する際に <div id=\"guide_main\"></div>　を置き忘れています。");
  throw "div error";
}
var scr_dataurl = (location.protocol == "file:") ? "./data.js" : "https://thenyutheta.github.io/KCW_TRAIN_GUIDE/data.js";
...
scr_data.src = scr_dataurl + '?version=' + g_Version;
scr_data.onload = function () {
  var scr_core = document.createElement("script");
  scr_core.src = scr_coreurl + '?version=' + g_Version;
